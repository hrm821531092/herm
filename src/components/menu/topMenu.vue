<template>
    <div class="menupage">
      <el-menu
        ...
        <p class="logo-title"><i class="el-icon-user"></i>Gnn</p>
        <el-menu-item index="1" style="margin-left:250px;">全是你</el-menu-item>
        <el-menu-item index="2">你说的</el-menu-item>
        <el-menu-item index="3">你想的</el-menu-item>
        <el-menu-item index="4">你喜欢的</el-menu-item>
      </el-menu>
    </div>
</template>
